...
// // // // // // ── disclaimer blob ──────────────────────────────────────────────────────────
// // // // // function DisclaimerBlob({ position = "top" }) {
// // // // //   const isTop = position === "top";
// // // // //   return (
// // // // //     <div style={{
// // // // //       width: "100%",
// // // // //       background: `linear-gradient(135deg, #2A1A0E, #1D1209)`,
// // // // //       border: `1.5px solid #F59E0B88`,
// // // // //       borderRadius: 16,
// // // // //       padding: "16px 18px",
// // // // //       marginBottom: isTop ? 24 : 0,
// // // // //       marginTop: isTop ? 0 : 24,
// // // // //       display: "flex", gap: 12, alignItems: "flex-start",
// // // // //     }}>
// // // // //       <span style={{ fontSize: 22, flexShrink: 0, marginTop: 1 }}>⚠️</span>
// // // // //       <div>
// // // // //         <div style={{ fontSize: 12, fontWeight: 700, color: "#F59E0B", letterSpacing: 1, marginBottom: 5 }}>
// // // // //           IMPORTANT DISCLAIMER
// // // // //         </div>
// // // // //         <p style={{ fontSize: 12, color: "#D4A96A", lineHeight: 1.65, margin: 0 }}>
// // // // //           These results are AI-generated estimates based on the submitted photos and may not accurately reflect your actual features.
// // // // //           Lighting, angle, image quality, and other factors significantly affect the analysis.{" "}
// // // // //           <strong style={{ color: "#F59E0B" }}>This is not medical advice.</strong>{" "}
// // // // //           Do not make any health, skincare, or lifestyle decisions based solely on this analysis.
// // // // //           Always consult a qualified dermatologist, doctor, or healthcare professional before following any recommendations.
// // // // //         </p>
// // // // //       </div>
// // // // //     </div>
// // // // //   );
...
// // // // //         <div style={{ fontSize: 56, fontWeight: 700, fontFamily: "'Syne', sans-serif", color: C.text, lineHeight: 1, letterSpacing: -2 }}>{display}</div>
...
// // // // //   facial_hair:        { label: "Facial Hair",   weight: "0.9×" },
// // // // //   skin_quality:       { label: "Skin Quality",  weight: "1.1×" },
// // // // //   jawline:            { label: "Jawline",        weight: "1.3×" },
// // // // //   cheekbones_midface: { label: "Cheekbones",    weight: "1.1×" },
// // // // //   nose:               { label: "Nose",           weight: "1.0×" },
// // // // //   lips:               { label: "Lips",           weight: "0.9×" },
// // // // //   overall_harmony:    { label: "Harmony",        weight: "1.5×" },
// // // // // };
...
// // // // //             <span style={{ fontSize: 15, fontWeight: 600, color: C.text }}>{area.area}</span>
// // // // //             <span style={{
...
// // // // //             <span style={{ fontSize: 20, fontWeight: 700, color: zoneColor, fontFamily: "'Syne', sans-serif" }}>
...
// // // // //           </div>
// // // // //         </div>
// // // // //         <span style={{ color: C.muted, fontSize: 14, transition: "transform .2s", transform: open ? "rotate(180deg)" : "none" }}>▾</span>
// // // // //       </div>

// // // // //       {open && (
// // // // //         <div style={{ padding: "0 18px 18px", animation: "fade .3s ease" }}>
// // // // //           {area.why_it_matters && (
// // // // //             <p style={{ fontSize: 13, color: C.muted, lineHeight: 1.6, marginBottom: 14 }}>{area.why_it_matters}</p>
// // // // //           )}
// // // // //           {area.action_steps?.map((step, j) => (
// // // // //             <div key={j} style={{ background: C.cardHi, borderRadius: 10, padding: "13px 14px", marginBottom: 10 }}>
// // // // //               {step.step && (
// // // // //                 <div style={{ fontSize: 14, color: C.text, lineHeight: 1.5, marginBottom: step.products_or_options || step.products ? 10 : 0 }}>
// // // // //                   {step.step}
// // // // //                 </div>
// // // // //               )}
// // // // //               {/* handle both key names from Claude */}
...
// // // // //         {/* header */}
// // // // //         <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, animation: "rise .5s ease" }}>
// // // // //           <OzenWordmark size={16} />
// // // // //           <button onClick={onReset} style={{ background: "none", border: `1px solid ${C.line}`, color: C.muted, borderRadius: 20, padding: "6px 14px", fontSize: 12, cursor: "pointer" }}>
// // // // //             New scan
// // // // //           </button>
// // // // //         </div>

// // // // //         {/* ── TOP DISCLAIMER ── */}
// // // // //         <div style={{ animation: "rise .5s ease .02s both" }}>
// // // // //           <DisclaimerBlob position="top" />
// // // // //         </div>

// // // // //         {/* overall hero */}
// // // // //         <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginBottom: 24, animation: "rise .6s ease .06s both" }}>
// // // // //           <HeroGauge score={overall} />
// // // // //           <div style={{ marginTop: 14, textAlign: "center" }}>
// // // // //             {(result.detected_ethnicity || result.face_shape) && (
// // // // //               <div style={{ display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap", marginBottom: 10 }}>
// // // // //                 {[result.detected_ethnicity, result.face_shape && `${result.face_shape} face`].filter(Boolean).map((tag) => (
// // // // //                   <span key={tag} style={{ fontSize: 11, color: C.iceDim, background: C.card, border: `1px solid ${C.line}`, borderRadius: 999, padding: "4px 12px" }}>{tag}</span>
// // // // //                 ))}
// // // // //               </div>
// // // // //             )}
// // // // //             {potential > 0 && (
...
// // // // //         {/* overall score bar */}
// // // // //         <div style={{ background: C.card, border: `1px solid ${C.line}`, borderRadius: 14, padding: 18, marginBottom: 22, animation: "rise .5s ease .1s both" }}>
// // // // //           <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 10 }}>
// // // // //             <span style={{ fontSize: 11, letterSpacing: 2, color: C.muted }}>OVERALL SCORE</span>
// // // // //             <span style={{ fontSize: 22, fontWeight: 700, fontFamily: "'Syne', sans-serif", color: scoreColor10(overall) }}>{overall.toFixed(1)}</span>
// // // // //           </div>
...
// // // // //           <div style={{ background: C.card, border: `1px solid ${C.line}`, borderRadius: 12, padding: "12px 15px", marginBottom: 20, fontSize: 12, color: C.muted, lineHeight: 1.55, animation: "rise .5s ease .12s both" }}>
// // // // //             <span style={{ color: C.iceDim, fontWeight: 500 }}>Image conditions: </span>
// // // // //             {typeof result.image_conditions === "string"
// // // // //               ? result.image_conditions
// // // // //               : [result.image_conditions.lighting, result.image_conditions.angle_quality || result.image_conditions.angle, result.image_conditions.compensation_applied].filter(Boolean).join(" · ")}
// // // // //           </div>
// // // // //         )}

// // // // //         {/* strengths */}
// // // // //         {result.strengths?.length > 0 && (
// // // // //           <div style={{ background: `${C.good}12`, border: `1px solid ${C.good}44`, borderRadius: 14, padding: 18, marginBottom: 20, animation: "rise .5s ease .14s both" }}>
// // // // //             <div style={{ fontSize: 10, letterSpacing: 2, color: C.good, marginBottom: 10 }}>YOUR STRENGTHS</div>
// // // // //             {result.strengths.map((s, i) => (
// // // // //               <div key={i} style={{ fontSize: 14, color: C.text, lineHeight: 1.55, marginBottom: i < result.strengths.length - 1 ? 6 : 0 }}>· {s}</div>
// // // // //             ))}
// // // // //           </div>
// // // // //         )}

// // // // //         {/* ── ALL 10 SCORES with observations ── */}
// // // // //         <div style={{ marginBottom: 22, animation: "rise .5s ease .16s both" }}>
// // // // //           <div style={{ fontSize: 10, letterSpacing: 2, color: C.muted, marginBottom: 12 }}>ALL PARAMETERS</div>
// // // // //           <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
// // // // //             {Object.entries(scores).map(([key, val], i) => {
// // // // //               const meta  = SCORE_META[key] || { label: key, weight: "" };
...
// // // // //                   padding: "14px 16px",
// // // // //                   animation: `rise .4s ease ${0.16 + i * 0.04}s both`,
// // // // //                 }}>
// // // // //                   {/* score row */}
// // // // //                   <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: obs ? 10 : 0 }}>
// // // // //                     <SmallRing score={score} delay={300 + i * 60} />
// // // // //                     <div style={{ flex: 1 }}>
// // // // //                       <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 7 }}>
// // // // //                         <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
// // // // //                           <span style={{ fontSize: 13, color: C.text, fontWeight: 500 }}>{meta.label}</span>
// // // // //                           <span style={{ fontSize: 9, color: C.muted }}>{meta.weight}</span>
// // // // //                         </div>
// // // // //                         <span style={{ fontSize: 18, fontWeight: 700, fontFamily: "'Syne', sans-serif", color: scoreColor10(score) }}>
// // // // //                           {score.toFixed(1)}
// // // // //                         </span>
// // // // //                       </div>
// // // // //                       <ScoreBar score={score} delay={300 + i * 60} />
// // // // //                     </div>
// // // // //                   </div>
// // // // //                   {/* observation text */}
// // // // //                   {obs && (
...
// // // // //             <div style={{ fontSize: 10, letterSpacing: 2, color: C.muted, marginBottom: 12 }}>FOCUS AREAS</div>
// // // // //             <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
// // // // //               {result.primary_focus_areas.map((area, i) => <FocusCard key={i} area={area} index={i} />)}
// // // // //             </div>
// // // // //           </div>
// // // // //         )}
...
// // // // //           }}>
// // // // //             <div style={{ fontFamily: "'Syne', sans-serif", fontSize: 17, fontWeight: 700, marginBottom: 14 }}>Your 30-day protocol</div>
// // // // //             {(result["30_day_protocol"] || result.thirty_day_protocol).map((item, i) => (
// // // // //               <div key={i} style={{ display: "flex", gap: 12, marginBottom: 10, fontSize: 13, color: C.text, lineHeight: 1.55 }}>
// // // // //                 <span style={{ color: C.indigoBright, fontWeight: 700, flexShrink: 0, fontFamily: "'Syne', sans-serif" }}>{i + 1}.</span>
// // // // //                 <span>{item}</span>
// // // // //               </div>
// // // // //             ))}
// // // // //           </div>
...
// // // // //         {/* metrics */}
// // // // //         {result.metrics && (
// // // // //           <div style={{ background: C.card, border: `1px solid ${C.line}`, borderRadius: 14, padding: 18, marginBottom: 22, animation: "rise .5s ease .38s both" }}>
...
// // // // //                 ["Symmetry", result.metrics.symmetry_deviation_pct != null ? `${result.metrics.symmetry_deviation_pct}%` : null],
...
// // // // //                   <div style={{ fontSize: 15, color: C.text, fontFamily: "'Syne', sans-serif", fontWeight: 600 }}>{val}</div>
// // // // //                 </div>
// // // // //               ))}
// // // // //             </div>
// // // // //           </div>
...
// // // // //         {/* ── BOTTOM DISCLAIMER ── */}
// // // // //         <DisclaimerBlob position="bottom" />
...
// // // // // ── disclaimer blob ──────────────────────────────────────────────────────────
// // // // // Demoted: smaller, muted, bottom-only as per UX feedback
...
// // // // // Each of the 10 scores is now a collapsible card.
// // // // // Header row always visible: ring + label + score number + chevron.
// // // // // Observation text and score bar sit inside the collapsed body.
...
// // // //         {/* chevron — only shown if there's something to expand */}
// // // //         {hasObs && (
// // // //           <span style={{
// // // //             color: C.muted,
// // // //             fontSize: 13,
...
// // // //         }}>
// // // //           {/* score bar inside expanded section */}
...
// // // //             <span style={{ fontSize: 14, fontWeight: 600, color: C.text }}>{area.area}</span>
// // // //             <span style={{
// // // //               fontSize: 9, letterSpacing: 1, color: zoneColor,
// // // //               border: `1px solid ${zoneColor}55`, borderRadius: 6, padding: "2px 7px",
// // // //             }}>{(area.zone || "").toUpperCase()}</span>
...
// // // //         {/* ── all 10 parameters — now accordion cards ── */}
...
// // // //         {/* ── focus areas — accordion, first open ── */}
// // // //         {result.primary_focus_areas?.length > 0 && (
// // // //           <div style={{ marginBottom: 22 }}>
...
// // // //         {/* ── disclaimer — demoted to bottom, muted ── */}
// // // //         <DisclaimerBlob />
...
// // //     .filter(([key]) => SCORE_META[key]) // only show the 7 known params
// // //     .sort(([, a], [, b]) => Number(b) - Number(a));

// // //   // First card shown free, rest blurred until unlocked
// // //   const FREE_COUNT = 1;
